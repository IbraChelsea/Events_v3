...
?>
                        ...
                        <!--<div class="labelSpacing">
                            <label>Împreună cu 1 însoţitor:*</label>
                            ...
                            <input data-dojo-type="dijit/form/RadioButton" required type="radio" name="begleitung" id="begleitung-1" class="popRadio" style="vertical-align:top;height:18px;" value="1" checked /> <label for="begleitung-1" style=" line-height:22px;">Nu</label>
                        </div>-->
                    </div>
                    <div id="buttonline">
